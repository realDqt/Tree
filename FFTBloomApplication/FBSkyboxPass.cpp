...
void FBSkyboxPass::createRenderPass() {
...
void FBSkyboxPass::createDescriptorSetLayout()
{
    ...
    std::array<VkDescriptorSetLayoutBinding, 2> bindings = {uboLayoutBinding, cubemapLayoutBinding};
...
void FBSkyboxPass::createFramebuffers() {
...
void FBSkyboxPass::createUniformBuffers(){
...
void FBSkyboxPass::createDescriptorPool() {
...
void FBSkyboxPass::createDescriptorSets() {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        imageInfo.imageView = envCubemapView;
...
void FBSkyboxPass::updateUniformBuffer(uint32_t currentImage){
...
VkShaderModule FBSkyboxPass::createShaderModule(const std::vector<char>& code) const {
...
void FBSkyboxPass::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
