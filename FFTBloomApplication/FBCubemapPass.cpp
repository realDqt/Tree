...
void FBCubemapPass::createDescriptorSetLayout()
{
    ...
    std::array<VkDescriptorSetLayoutBinding, 2> bindings = {uboLayoutBinding, hdrLayoutBinding};
...
void FBCubemapPass::createFramebuffers() {
    ...
    for (size_t i = 0; i < 1; i++) {
        ...
        framebufferInfo.width = FB_CUBEMAP_RESOLUTION;
        framebufferInfo.height = FB_CUBEMAP_RESOLUTION;
...
void FBCubemapPass::createUniformBuffers(){
...
void FBCubemapPass::createDescriptorPool() {
...
void FBCubemapPass::createDescriptorSets() {
...
void FBCubemapPass::updateUniformBuffer(){
...
VkShaderModule FBCubemapPass::createShaderModule(const std::vector<char>& code) const {
...
void FBCubemapPass::recordCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    renderPassInfo.renderArea.extent = VkExtent2D(FB_CUBEMAP_RESOLUTION, FB_CUBEMAP_RESOLUTION);
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float) FB_CUBEMAP_RESOLUTION;
    viewport.height = (float) FB_CUBEMAP_RESOLUTION;
    ...
    VkRect2D scissor{};
    scissor.offset = {0, 0};
    scissor.extent = VkExtent2D(FB_CUBEMAP_RESOLUTION, FB_CUBEMAP_RESOLUTION);
