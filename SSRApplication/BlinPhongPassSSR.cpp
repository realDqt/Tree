...
void BlinPhongPassSSR::createRenderPass() {
    VkAttachmentDescription colorAttachment{};
    colorAttachment.format = swapChainImageFormat;
    colorAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
    colorAttachment.loadOp = clearAttachments ? VK_ATTACHMENT_LOAD_OP_CLEAR : VK_ATTACHMENT_LOAD_OP_LOAD;
    colorAttachment.storeOp = VK_ATTACHMENT_STORE_OP_STORE;
    colorAttachment.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
    colorAttachment.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;
    colorAttachment.initialLayout = clearAttachments ? VK_IMAGE_LAYOUT_UNDEFINED : VK_IMAGE_LAYOUT_PRESENT_SRC_KHR;
...
void BlinPhongPassSSR::createGraphicsPipeline() {
...
void BlinPhongPassSSR::createFramebuffers() {
...
void BlinPhongPassSSR::createUniformBuffers() {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        createBuffer(physicalDevice, device, bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, uniformBuffers2[i], uniformBuffersMemory2[i]);
...
void BlinPhongPassSSR::createDescriptorPool() {
...
void BlinPhongPassSSR::createDescriptorSets() {
...
void BlinPhongPassSSR::createDescriptorSetLayout() {
...
VkShaderModule BlinPhongPassSSR::createShaderModule(const std::vector<char>& code) const {
...
void BlinPhongPassSSR::updateUniformBuffer(uint32_t currentImage) {
...
void BlinPhongPassSSR::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
