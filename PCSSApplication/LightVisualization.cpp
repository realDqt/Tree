...
void LightVisualizationPass::createRenderPass() {
...
void LightVisualizationPass::createDescriptorSetLayout()
{
...
void LightVisualizationPass::createFramebuffers() {
...
void LightVisualizationPass::createUniformBuffers(){
...
void LightVisualizationPass::createDescriptorPool() {
...
void LightVisualizationPass::createDescriptorSets() {
...
void LightVisualizationPass::updateUniformBuffer(uint32_t currentImage){
...
VkShaderModule LightVisualizationPass::createShaderModule(const std::vector<char>& code) const {
...
void LightVisualizationPass::cleanup() {
...
void LightVisualizationPass::init()
{
    createRenderPass();
    createFramebuffers();
...
void LightVisualizationPass::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
