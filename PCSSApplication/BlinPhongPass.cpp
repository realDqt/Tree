...
void BlinPhongPass::createRenderPass() {
...
void BlinPhongPass::createFramebuffers() {
...
void BlinPhongPass::createUniformBuffers() {
...
void BlinPhongPass::createLightBuffers(){
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        createBuffer(physicalDevice, device, bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, lightBuffers[i], lightBuffersMemory[i]);

        vkMapMemory(device, lightBuffersMemory[i], 0, bufferSize, 0, &lightBuffersMapped[i]);
    }
}

void BlinPhongPass::createDescriptorPool() {
...
void BlinPhongPass::createDescriptorSets() {
...
void BlinPhongPass::createDescriptorSetLayout() {
...
VkShaderModule BlinPhongPass::createShaderModule(const std::vector<char>& code) const {
...
void BlinPhongPass::updateUniformBuffer(uint32_t currentImage) {
...
void BlinPhongPass::updateLightBuffer(uint32_t currentImage){
...
void BlinPhongPass::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
    ...
    VkBuffer vertexBuffers[] = {vertexBufferMarry};
    VkDeviceSize offsets[] = {0};
    vkCmdBindVertexBuffers(commandBuffer, 0, 1, vertexBuffers, offsets);

    vkCmdBindIndexBuffer(commandBuffer, indexBufferMarry, 0, VK_INDEX_TYPE_UINT32);

    vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 0, 1, &descriptorSets[currentFrame], 0, nullptr);

    vkCmdDrawIndexed(commandBuffer, indicesCountMarry, 1, 0, 0, 0);
    ...
    VkBuffer vertexBuffers2[] = {vertexBufferFloor};
    VkDeviceSize offsets2[] = {0};
    vkCmdBindVertexBuffers(commandBuffer, 0, 1, vertexBuffers2, offsets2);

    vkCmdBindIndexBuffer(commandBuffer, indexBufferFloor, 0, VK_INDEX_TYPE_UINT32);
