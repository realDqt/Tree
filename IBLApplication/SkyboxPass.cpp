...
void SkyboxPass::updateUniformBuffer(uint32_t currentImage){
...
VkShaderModule SkyboxPass::createShaderModule(const std::vector<char>& code) const {
...
void SkyboxPass::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
