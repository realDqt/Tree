...
void HDRVisualizationPass::createRenderPass() {
...
void HDRVisualizationPass::createDescriptorSetLayout()
{
...
void HDRVisualizationPass::createFramebuffers() {
...
void HDRVisualizationPass::createUniformBuffers(){
...
void HDRVisualizationPass::createDescriptorPool() {
...
void HDRVisualizationPass::createDescriptorSets() {
...
VkShaderModule HDRVisualizationPass::createShaderModule(const std::vector<char>& code) const {
...
void HDRVisualizationPass::cleanup() {
...
void HDRVisualizationPass::init()
{
    createRenderPass();
    createFramebuffers();
...
void HDRVisualizationPass::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
