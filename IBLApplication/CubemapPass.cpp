...
void CubemapPass::createRenderPass() {
...
void CubemapPass::createDescriptorSetLayout()
{
...
void CubemapPass::createGraphicsPipeline(){
...
void CubemapPass::createFramebuffers() {
    ...
    for (size_t i = 0; i < 1; i++) {
        ...
        framebufferInfo.width = CUBEMAP_RESOLUTION;
        framebufferInfo.height = CUBEMAP_RESOLUTION;
...
void CubemapPass::createUniformBuffers(){
...
void CubemapPass::createDescriptorPool() {
...
void CubemapPass::createDescriptorSets() {
...
void CubemapPass::updateUniformBuffer(){
...
VkShaderModule CubemapPass::createShaderModule(const std::vector<char>& code) const {
...
void CubemapPass::recordCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    renderPassInfo.renderArea.extent = VkExtent2D(CUBEMAP_RESOLUTION, CUBEMAP_RESOLUTION);
    ...
    VkRect2D scissor{};
    scissor.offset = {0, 0};
    scissor.extent = VkExtent2D(CUBEMAP_RESOLUTION, CUBEMAP_RESOLUTION);
