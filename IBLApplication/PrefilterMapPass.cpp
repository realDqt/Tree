...
void PrefilterMapPass::createRenderPass() {
...
void PrefilterMapPass::createDescriptorSetLayout()
{
...
void PrefilterMapPass::createFramebuffers() {
    ...
    for (size_t i = 0; i < 1; i++) {
        ...
        framebufferInfo.width = colorImageExtent.width;
        framebufferInfo.height = colorImageExtent.height;
...
void PrefilterMapPass::createUniformBuffers(){
...
void PrefilterMapPass::createDescriptorPool() {
...
void PrefilterMapPass::createDescriptorSets() {
...
void PrefilterMapPass::updateUniformBuffer(){
...
VkShaderModule PrefilterMapPass::createShaderModule(const std::vector<char>& code) const {
...
void PrefilterMapPass::recordCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    renderPassInfo.renderArea.extent = colorImageExtent;
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float) colorImageExtent.width;
    viewport.height = (float) colorImageExtent.height;
    ...
    VkRect2D scissor{};
    scissor.offset = {0, 0};
    scissor.extent = colorImageExtent;
