...
void BrdfLUTPass::createFramebuffers() {
    ...
    for (size_t i = 0; i < 1; i++) {
        ...
        framebufferInfo.width = LUT_RESOLUTION;
        framebufferInfo.height = LUT_RESOLUTION;
...
VkShaderModule BrdfLUTPass::createShaderModule(const std::vector<char>& code) const {
...
void BrdfLUTPass::recordCommandBuffer(VkCommandBuffer commandBuffer)
{
    ...
    renderPassInfo.renderArea.extent = VkExtent2D(LUT_RESOLUTION, LUT_RESOLUTION);
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float) LUT_RESOLUTION;
    viewport.height = (float) LUT_RESOLUTION;
    ...
    VkRect2D scissor{};
    scissor.offset = {0, 0};
    scissor.extent = VkExtent2D(LUT_RESOLUTION, LUT_RESOLUTION);
